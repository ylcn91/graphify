...
""",
    ...
    assert canonical_file_id(str(layout)) in targets
    assert canonical_file_id(str(hero)) in targets
...
""",
    ...
    assert canonical_file_id(str(other)) in targets
...
""",
    ...
    targets = _import_targets(result, relation="imports_from")
    assert canonical_file_id(str(layout)) in targets
    assert canonical_file_id(str(hydrate)) in targets
